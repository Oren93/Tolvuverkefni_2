...
## e)
These vectors can also be used to illustrate the convergence towards a mean or expected value with larger and larger sample sizes. These four histograms show how with larger sample sizes the distribution gets closer and closer to the expected value.
